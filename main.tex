...
It's good practice to let the image inside the wrapfig just be a tiny bit smaller than the wrapfig environment. Thus you make sure the text and image are not overlapping, and that you
