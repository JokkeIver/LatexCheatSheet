...
Using these commands does a small different, but will look much prettier in the long run.


To get a longer list of all the different commands to the operators check under \hyperref[secc:Math-Operators]{Miscellaneous and Mathematics Operators}
\subsection{Symbols}
\subsection{Tables}
\subsection{Graphs}
\newpage
